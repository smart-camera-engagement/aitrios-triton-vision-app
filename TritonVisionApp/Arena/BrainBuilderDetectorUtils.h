...
//
// =============================================================================
#ifndef ARENA_EXAMPLE_BRAIN_BUILDEDR_DETECTOR_UTILS_H
#define ARENA_EXAMPLE_BRAIN_BUILDEDR_DETECTOR_UTILS_H
...
// ><><><><><><><><><><><><><><><><><><><><><><><><><><><><><><><><><><><><><><>
//  ArenaExample::BrainBuilderDetectorUtils class
// ><><><><><><><><><><><><><><><><><><><><><><><><><><><><><><><><><><><><><><>
class BrainBuilderDetectorUtils : public ObjectDetectionUtils
{
public:
  // Constants -----------------------------------------------------------------
  const int  kResultNum   = 100;
  ...
  // ---------------------------------------------------------------------------
  //  BrainBuilderDetectorUtils
  // ---------------------------------------------------------------------------
  BrainBuilderDetectorUtils(IMX501Utils* inIMX501Utils) :
  ...
  //  ~BrainBuilderDetectorUtils
  // ---------------------------------------------------------------------------
  virtual ~BrainBuilderDetectorUtils()
  {
  }
...
#endif //ARENA_EXAMPLE_BRAIN_BUILDEDR_DETECTOR_UTILS_H
